...
#define FOREACH_APEX_STRING_OPTION(macro) \
    ...
    macro (APEX_KOKKOS_TUNING_POLICY, kokkos_tuning_policy, char*, "automatic", "Kokkos autotuning policy: random, exhaustive, simulated_annealing, nelder_mead, automatic.") \
