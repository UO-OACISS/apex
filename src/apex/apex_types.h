...
#define FOREACH_APEX_OPTION(macro) \
    ...
    macro (APEX_PROC_CPUINFO, use_proc_cpuinfo, int, 0) \
    macro (APEX_PROC_MEMINFO, use_proc_meminfo, int, 0) \
    macro (APEX_PROC_NET_DEV, use_proc_net_dev, int, 0) \
    macro (APEX_PROC_SELF_STATUS, use_proc_self_status, int, 0) \
    macro (APEX_PROC_STAT, use_proc_stat, int, 0) \
