...
{ APEX_TRACER ; APEX_UNUSED(clock_domain); APEX_UNUSED(timestamp);
APEX_UNUSED(id); }
...
{ APEX_TRACER ; APEX_UNUSED(domain); APEX_UNUSED(clock_domain);
APEX_UNUSED(timestamp); APEX_UNUSED(id); }
...
{ APEX_TRACER ; APEX_UNUSED(domain); APEX_UNUSED(id); APEX_UNUSED(name) ;
APEX_UNUSED(scope); }
...
{ APEX_TRACER ; APEX_UNUSED(domain); APEX_UNUSED(scope); APEX_UNUSED(key) ;
APEX_UNUSED(type); APEX_UNUSED(count) ; APEX_UNUSED(data); }
void __itt_metadata_str_add (const __itt_domain * domain,
      __itt_id id, __itt_string_handle * key, const char * data, size_t length)
{ APEX_TRACER ; APEX_UNUSED(domain); APEX_UNUSED(id); APEX_UNUSED(key) ;
APEX_UNUSED(data); APEX_UNUSED(length); }
...
{ APEX_TRACER ; APEX_UNUSED(domain); APEX_UNUSED(head); APEX_UNUSED(relation) ;
APEX_UNUSED(tail); }
...
{ APEX_TRACER ; APEX_UNUSED(domain); APEX_UNUSED(clock_domain);
APEX_UNUSED(timestamp) ; APEX_UNUSED(id); APEX_UNUSED(parentid);
APEX_UNUSED(name); }
void __itt_task_begin_fn(const __itt_domain * domain, __itt_id taskid,
      __itt_id parentid, void * fn)
{ APEX_TRACER ; APEX_UNUSED(domain); APEX_UNUSED(taskid);
APEX_UNUSED(parentid); APEX_UNUSED(fn);}
...
{ APEX_TRACER ; APEX_UNUSED(domain); APEX_UNUSED(id); APEX_UNUSED(parentid);
APEX_UNUSED(name);}
__itt_track_group* __itt_track_group_create(__itt_string_handle* name,
      __itt_track_group_type type)
{ APEX_TRACER ; APEX_UNUSED(name); APEX_UNUSED(type); return nullptr; }
__itt_track* __itt_track_create(__itt_track_group* track_group,
      __itt_string_handle* name, __itt_track_type track_type)
{ APEX_TRACER ; APEX_UNUSED(track_group); APEX_UNUSED(name);
APEX_UNUSED(track_type); return nullptr; }
...
__itt_string_handle* __itt_string_handle_create(char const* name) {
  ...
  __itt_string_handle *string_handle =
    (__itt_string_handle*)(malloc(sizeof(__itt_string_handle)));
  string_handle->strA = strdup(name);
  return string_handle;
}

void __itt_task_begin(__itt_domain const* domain, __itt_id taskid, __itt_id
    parentid, __itt_string_handle* handle) {
  APEX_TRACER
  APEX_UNUSED(domain);
  APEX_UNUSED(taskid);
...
ITTNOTIFY_EXPORT __itt_mark_type (*__itt_mark_createA_ptr_)(char const* name) =
__itt_mark_create;
ITTNOTIFY_EXPORT int (*__itt_markA_ptr_)(__itt_mark_type mark, char const* par)
= __itt_mark;
#else
ITTNOTIFY_EXPORT __itt_mark_type (*__itt_mark_create_ptr_)(char const* name) =
__itt_mark_create;
ITTNOTIFY_EXPORT int (*__itt_mark_ptr_)(__itt_mark_type mark, char const* par)
= __itt_mark;
#endif
ITTNOTIFY_EXPORT int (*__itt_mark_off_ptr_)(__itt_mark_type mark) =
__itt_mark_off;
ITTNOTIFY_EXPORT void (*__itt_stack_callee_enter_ptr_)(__itt_caller ctx) =
__itt_stack_callee_enter;
ITTNOTIFY_EXPORT void (*__itt_stack_callee_leave_ptr_)(__itt_caller ctx) =
__itt_stack_callee_leave;
ITTNOTIFY_EXPORT __itt_caller (*__itt_stack_caller_create_ptr_)() =
__itt_stack_caller_create;
ITTNOTIFY_EXPORT void (*__itt_stack_caller_destroy_ptr_)(__itt_caller ctx) =
