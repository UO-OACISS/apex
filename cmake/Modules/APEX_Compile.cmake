...
set(APEX_COMPILE_LOADED TRUE)

include(APEX_Include)

apex_include(ParseArguments)

macro(apex_compile_object name)
  apex_parse_arguments(${name}
...
macro(apex_compile name)
  ...
  if(${name}_QUIET)
    apex_debug("compile" "${CMAKE_${${name}_LANGUAGE}_COMPILER}"
