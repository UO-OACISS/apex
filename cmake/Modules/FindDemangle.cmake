...
find_path(DEMANGLE_INCLUDE_DIR demangle.h
          ...
          ${DEMANGLE_ROOT}/include ${BINUTILS_ROOT}/include /usr/include 
          ${PC_DEMANGLE_INCLUDEDIR}/* ${PC_DEMANGLE_INCLUDE_DIRS}/* 
          ${DEMANGLE_ROOT}/* ${BINUTILS_ROOT}/* /usr/include/*
          PATH_SUFFIXES DEMANGLE )

find_library(DEMANGLE_LIBRARY NAMES iberty
    HINTS ${PC_DEMANGLE_LIBDIR} ${PC_DEMANGLE_LIBRARY_DIRS} ${DEMANGLE_ROOT}/lib ${BINUTILS_ROOT}/lib)
