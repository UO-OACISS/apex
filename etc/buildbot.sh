...
no_ompt=" -DAPEX_WITH_OMPT=FALSE"
no_papi=" -DAPEX_WITH_PAPI=FALSE"
no_mpi=" -DAPEX_WITH_MPI=FALSE"
no_otf=" -DAPEX_WITH_OTF2=FALSE"
no_tau=" -DAPEX_WITH_TAU=FALSE"
yes_malloc=" -DAPEX_WITH_JEMALLOC=TRUE"
...
yes_ompt=" -DAPEX_WITH_OMPT=TRUE -DOMPT_ROOT=/usr/local/ompt/5.0"
#yes_mpi=" -DAPEX_WITH_MPI=TRUE -DCMAKE_C_COMPILER=mpicc -DCMAKE_CXX_COMPILER=mpicxx"
yes_mpi=" -DAPEX_WITH_MPI=TRUE"
yes_papi=" -DAPEX_WITH_PAPI=TRUE -DPAPI_ROOT=/usr"
yes_tau=" -DAPEX_WITH_TAU=TRUE "
if [ "$host" == "delphi" ] ; then
  yes_bfd=" -DAPEX_WITH_BFD=TRUE -DBFD_ROOT=/usr/local/packages/binutils/2.27"
  yes_malloc=" -DAPEX_WITH_JEMALLOC=TRUE -DJEMALLOC_ROOT=/usr/local/packages/jemalloc/5.0.1-gcc"
  yes_ah=" -DAPEX_WITH_ACTIVEHARMONY=TRUE -DACTIVEHARMONY_ROOT=/usr/local/packages/activeharmony/4.6.0-gcc -DAPEX_WITH_PLUGINS=TRUE"
  yes_otf=" -DAPEX_WITH_OTF2=TRUE -DOTF2_ROOT=/usr/local/packages/otf2/2.1"
  yes_ompt=" -DAPEX_WITH_OMPT=TRUE -DOMPT_ROOT=/usr/local/packages/llvm-openmp/2020-03-25"
  yes_papi=" -DAPEX_WITH_PAPI=TRUE -DPAPI_ROOT=/usr/local/packages/papi/5.6.0"
fi
